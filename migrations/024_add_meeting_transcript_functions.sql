-- Migration: Add meeting transcript retrieval functions
-- Created: 2025-07-22

-- Function to get meeting transcript with all details
...
BEGIN
    ...
    -- Calculate duration (start_time and end_time are not in block_meetings table)
    duration_mins := 0;
