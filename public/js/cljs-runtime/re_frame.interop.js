...
return [(function (){var pred__8782 = cljs.core.instance_QMARK_;
var expr__8783 = reactive_val;
if(cljs.core.truth_((pred__8782.cljs$core$IFn$_invoke$arity$2 ? pred__8782.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__8783) : pred__8782.call(null,reagent.ratom.RAtom,expr__8783)))){
return "ra";
} else {
if(cljs.core.truth_((pred__8782.cljs$core$IFn$_invoke$arity$2 ? pred__8782.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__8783) : pred__8782.call(null,reagent.ratom.RCursor,expr__8783)))){
return "rc";
} else {
if(cljs.core.truth_((pred__8782.cljs$core$IFn$_invoke$arity$2 ? pred__8782.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__8783) : pred__8782.call(null,reagent.ratom.Reaction,expr__8783)))){
return "rx";
} else {
if(cljs.core.truth_((pred__8782.cljs$core$IFn$_invoke$arity$2 ? pred__8782.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__8783) : pred__8782.call(null,reagent.ratom.Track,expr__8783)))){
return "tr";
} else {
return "other";
}
