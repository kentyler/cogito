...
return (function() { 
var G__12104__delegate = function (args){
...
var G__12104 = function (var_args){
var args = null;
...
while (G__12105__i < G__12105__a.length) {G__12105__a[G__12105__i] = arguments[G__12105__i + 0]; ++G__12105__i;}
  args = new cljs.core.IndexedSeq(G__12105__a,0,null);
} 
return G__12104__delegate.call(this,args);};
G__12104.cljs$lang$maxFixedArity = 0;
G__12104.cljs$lang$applyTo = (function (arglist__12106){
var args = cljs.core.seq(arglist__12106);
return G__12104__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__12020 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12021 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12021);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12020);
}});
...
var c = this;
var G__12070_12110 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__12070_12110 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12070_12110);
}
...
var renders_12112 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_12113 = cljs.core.first(cljs.core.vals(renders_12112));
...
if((cljs.core.count(renders_12112) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_12112))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_12113)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_12113], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
