...
var G__11172 = request;
var G__11173 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__11172,G__11173) : ajax.formats.get_format.call(null,G__11172,G__11173));
} else {
...
return cljs.core.some((function (p1__11191_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__11191_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__11192){
var map__11193 = p__11192;
var map__11193__$1 = cljs.core.__destructure_map(map__11193);
var request = map__11193__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11193__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__11199 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__11199.cljs$core$IFn$_invoke$arity$1 ? fexpr__11199.cljs$core$IFn$_invoke$arity$1(response) : fexpr__11199.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__11201){
var map__11202 = p__11201;
var map__11202__$1 = cljs.core.__destructure_map(map__11202);
var request = map__11202__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11202__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__11200_SHARP_){
return ajax.formats.get_accept_entries(request,p1__11200_SHARP_);
