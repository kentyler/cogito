...
return cljs.core.chunk_cons(cljs.core.chunk(b__10692),cogito$story_arc$segment_card_$_iter__10689(cljs.core.chunk_rest(s__10690__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__10692),null);
}
} else {
var theme = cljs.core.first(s__10690__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.px-2.py-1.bg-gray-100.text-gray-700.text-xs.rounded-full","span.px-2.py-1.bg-gray-100.text-gray-700.text-xs.rounded-full",1111534145),theme], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),theme], null)),cogito$story_arc$segment_card_$_iter__10689(cljs.core.rest(s__10690__$2)));
}
} else {
return null;
}
...
var segment = cljs.core._nth(c__5478__auto__,i__10778);
cljs.core.chunk_append(b__10779,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cogito.story_arc.segment_card,segment], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"segment-id","segment-id",1810133590).cljs$core$IFn$_invoke$arity$1(segment)], null)));

var G__11003 = (i__10778 + (1));
i__10778 = G__11003;
continue;
} else {
return true;
...
})()], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.grid.md:grid-cols-3.gap-6","div.grid.md:grid-cols-3.gap-6",1272419766),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3.text-lg.font-semibold.text-gray-800.mb-3","h3.text-lg.font-semibold.text-gray-800.mb-3",1819014241),"\uD83D\uDD00 Major Topic Shifts"], null),(function (){var iter__5480__auto__ = (function cogito$story_arc$story_arc_component_$_iter__10802(s__10803){
return (new cljs.core.LazySeq(null,(function (){
var s__10803__$1 = s__10803;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__10803__$1);
if(temp__5804__auto__){
var s__10803__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__10803__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__10803__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__10805 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__10804 = (0);
while(true){
if((i__10804 < size__5479__auto__)){
var vec__10810 = cljs.core._nth(c__5478__auto__,i__10804);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10810,(0),null);
var moment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10810,(1),null);
cljs.core.chunk_append(b__10805,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cogito.story_arc.key_moment_badge,moment,"topic shift"], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),idx], null)));

var G__11011 = (i__10804 + (1));
i__10804 = G__11011;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__10805),cogito$story_arc$story_arc_component_$_iter__10802(cljs.core.chunk_rest(s__10803__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__10805),null);
}
} else {
var vec__10813 = cljs.core.first(s__10803__$2);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10813,(0),null);
var moment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10813,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cogito.story_arc.key_moment_badge,moment,"topic shift"], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),idx], null)),cogito$story_arc$story_arc_component_$_iter__10802(cljs.core.rest(s__10803__$2)));
}
} else {
return null;
}
...
})()], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3.text-lg.font-semibold.text-gray-800.mb-3","h3.text-lg.font-semibold.text-gray-800.mb-3",1819014241),"\uD83D\uDD04 Callback Moments"], null),(function (){var iter__5480__auto__ = (function cogito$story_arc$story_arc_component_$_iter__10824(s__10825){
return (new cljs.core.LazySeq(null,(function (){
var s__10825__$1 = s__10825;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__10825__$1);
if(temp__5804__auto__){
var s__10825__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__10825__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__10825__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__10827 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__10826 = (0);
while(true){
if((i__10826 < size__5479__auto__)){
var vec__10833 = cljs.core._nth(c__5478__auto__,i__10826);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10833,(0),null);
var moment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10833,(1),null);
cljs.core.chunk_append(b__10827,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cogito.story_arc.key_moment_badge,moment,"callback"], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),idx], null)));

var G__11021 = (i__10826 + (1));
i__10826 = G__11021;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__10827),cogito$story_arc$story_arc_component_$_iter__10824(cljs.core.chunk_rest(s__10825__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__10827),null);
}
} else {
var vec__10839 = cljs.core.first(s__10825__$2);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10839,(0),null);
var moment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10839,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cogito.story_arc.key_moment_badge,moment,"callback"], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),idx], null)),cogito$story_arc$story_arc_component_$_iter__10824(cljs.core.rest(s__10825__$2)));
}
} else {
return null;
}
...
var c__5478__auto__ = cljs.core.chunk_first(s__10844__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__10846 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__10845 = (0);
while(true){
if((i__10845 < size__5479__auto__)){
var vec__10852 = cljs.core._nth(c__5478__auto__,i__10845);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10852,(0),null);
var moment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10852,(1),null);
cljs.core.chunk_append(b__10846,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cogito.story_arc.key_moment_badge,moment,"outlier"], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),idx], null)));

var G__11022 = (i__10845 + (1));
i__10845 = G__11022;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__10846),cogito$story_arc$story_arc_component_$_iter__10843(cljs.core.chunk_rest(s__10844__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__10846),null);
}
} else {
var vec__10857 = cljs.core.first(s__10844__$2);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10857,(0),null);
var moment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10857,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cogito.story_arc.key_moment_badge,moment,"outlier"], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),idx], null)),cogito$story_arc$story_arc_component_$_iter__10843(cljs.core.rest(s__10844__$2)));
}
} else {
return null;
}
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("story-arc","set-selected-segment","story-arc/set-selected-segment",-271480945),(function (db,p__10866){
var vec__10868 = p__10866;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10868,(0),null);
var segment_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10868,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("story-arc","toggle-moment-details","story-arc/toggle-moment-details",1744667405),(function (db,p__10873){
var vec__10878 = p__10873;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10878,(0),null);
var moment_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10878,(1),null);
