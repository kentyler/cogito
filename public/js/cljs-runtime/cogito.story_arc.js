...
return cljs.core.chunk_cons(cljs.core.chunk(b__6706),cogito$story_arc$segment_card_$_iter__6703(cljs.core.chunk_rest(s__6704__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__6706),null);
}
} else {
var theme = cljs.core.first(s__6704__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.px-2.py-1.bg-gray-100.text-gray-700.text-xs.rounded-full","span.px-2.py-1.bg-gray-100.text-gray-700.text-xs.rounded-full",1111534145),theme], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),theme], null)),cogito$story_arc$segment_card_$_iter__6703(cljs.core.rest(s__6704__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__6744),cogito$story_arc$story_arc_component_$_iter__6741(cljs.core.chunk_rest(s__6742__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__6744),null);
}
} else {
var segment = cljs.core.first(s__6742__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cogito.story_arc.segment_card,segment], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"segment-id","segment-id",1810133590).cljs$core$IFn$_invoke$arity$1(segment)], null)),cogito$story_arc$story_arc_component_$_iter__6741(cljs.core.rest(s__6742__$2)));
}
} else {
return null;
}
...
})()], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.grid.md:grid-cols-3.gap-6","div.grid.md:grid-cols-3.gap-6",1272419766),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3.text-lg.font-semibold.text-gray-800.mb-3","h3.text-lg.font-semibold.text-gray-800.mb-3",1819014241),"\uD83D\uDD00 Major Topic Shifts"], null),(function (){var iter__5480__auto__ = (function cogito$story_arc$story_arc_component_$_iter__6761(s__6762){
return (new cljs.core.LazySeq(null,(function (){
var s__6762__$1 = s__6762;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__6762__$1);
if(temp__5804__auto__){
var s__6762__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__6762__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__6762__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__6764 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__6763 = (0);
while(true){
if((i__6763 < size__5479__auto__)){
var vec__6769 = cljs.core._nth(c__5478__auto__,i__6763);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6769,(0),null);
var moment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6769,(1),null);
cljs.core.chunk_append(b__6764,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cogito.story_arc.key_moment_badge,moment,"topic shift"], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),idx], null)));

var G__6860 = (i__6763 + (1));
i__6763 = G__6860;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__6764),cogito$story_arc$story_arc_component_$_iter__6761(cljs.core.chunk_rest(s__6762__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__6764),null);
}
} else {
var vec__6777 = cljs.core.first(s__6762__$2);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6777,(0),null);
var moment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6777,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cogito.story_arc.key_moment_badge,moment,"topic shift"], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),idx], null)),cogito$story_arc$story_arc_component_$_iter__6761(cljs.core.rest(s__6762__$2)));
}
} else {
return null;
}
...
})()], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3.text-lg.font-semibold.text-gray-800.mb-3","h3.text-lg.font-semibold.text-gray-800.mb-3",1819014241),"\uD83D\uDD04 Callback Moments"], null),(function (){var iter__5480__auto__ = (function cogito$story_arc$story_arc_component_$_iter__6783(s__6784){
return (new cljs.core.LazySeq(null,(function (){
var s__6784__$1 = s__6784;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__6784__$1);
if(temp__5804__auto__){
var s__6784__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__6784__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__6784__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__6786 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__6785 = (0);
while(true){
if((i__6785 < size__5479__auto__)){
var vec__6802 = cljs.core._nth(c__5478__auto__,i__6785);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6802,(0),null);
var moment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6802,(1),null);
cljs.core.chunk_append(b__6786,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cogito.story_arc.key_moment_badge,moment,"callback"], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),idx], null)));

var G__6861 = (i__6785 + (1));
i__6785 = G__6861;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__6786),cogito$story_arc$story_arc_component_$_iter__6783(cljs.core.chunk_rest(s__6784__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__6786),null);
}
} else {
var vec__6809 = cljs.core.first(s__6784__$2);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6809,(0),null);
var moment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6809,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cogito.story_arc.key_moment_badge,moment,"callback"], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),idx], null)),cogito$story_arc$story_arc_component_$_iter__6783(cljs.core.rest(s__6784__$2)));
}
} else {
return null;
}
...
})()], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3.text-lg.font-semibold.text-gray-800.mb-3","h3.text-lg.font-semibold.text-gray-800.mb-3",1819014241),"\u26A1 Unique Moments"], null),(function (){var iter__5480__auto__ = (function cogito$story_arc$story_arc_component_$_iter__6819(s__6820){
return (new cljs.core.LazySeq(null,(function (){
var s__6820__$1 = s__6820;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__6820__$1);
if(temp__5804__auto__){
var s__6820__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__6820__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__6820__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__6822 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__6821 = (0);
while(true){
if((i__6821 < size__5479__auto__)){
var vec__6830 = cljs.core._nth(c__5478__auto__,i__6821);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6830,(0),null);
var moment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6830,(1),null);
cljs.core.chunk_append(b__6822,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cogito.story_arc.key_moment_badge,moment,"outlier"], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),idx], null)));

var G__6863 = (i__6821 + (1));
i__6821 = G__6863;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__6822),cogito$story_arc$story_arc_component_$_iter__6819(cljs.core.chunk_rest(s__6820__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__6822),null);
}
} else {
var vec__6833 = cljs.core.first(s__6820__$2);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6833,(0),null);
var moment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6833,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cogito.story_arc.key_moment_badge,moment,"outlier"], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),idx], null)),cogito$story_arc$story_arc_component_$_iter__6819(cljs.core.rest(s__6820__$2)));
}
} else {
return null;
}
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("story-arc","set-selected-segment","story-arc/set-selected-segment",-271480945),(function (db,p__6838){
var vec__6839 = p__6838;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6839,(0),null);
var segment_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6839,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("story-arc","toggle-moment-details","story-arc/toggle-moment-details",1744667405),(function (db,p__6842){
var vec__6843 = p__6842;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6843,(0),null);
var moment_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6843,(1),null);
