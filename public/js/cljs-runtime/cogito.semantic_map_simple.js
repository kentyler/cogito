...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("cogito.semantic-map-simple","set-current-meeting","cogito.semantic-map-simple/set-current-meeting",49777924),(function (db,p__11293){
var vec__11294 = p__11293;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11294,(0),null);
var meeting_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11294,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("cogito.semantic-map-simple","load-embeddings","cogito.semantic-map-simple/load-embeddings",1806309465),(function (p__11300,p__11301){
var map__11302 = p__11300;
var map__11302__$1 = cljs.core.__destructure_map(map__11302);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11302__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__11303 = p__11301;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11303,(0),null);
var block_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11303,(1),null);
fetch(["/api/meetings/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(block_id),"/embeddings"].join(''),({"credentials": "same-origin"})).then((function (p1__11297_SHARP_){
return p1__11297_SHARP_.json();
})).then((function (data){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("cogito.semantic-map-simple","embeddings-loaded","cogito.semantic-map-simple/embeddings-loaded",1400440837),(function (db,p__11317){
var vec__11326 = p__11317;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11326,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11326,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("cogito.semantic-map-simple","embeddings-load-failed","cogito.semantic-map-simple/embeddings-load-failed",-1671208516),(function (db,p__11333){
var vec__11334 = p__11333;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11334,(0),null);
var error = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11334,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("cogito.semantic-map-simple","set-selected-turn","cogito.semantic-map-simple/set-selected-turn",1855670088),(function (db,p__11337){
var vec__11338 = p__11337;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11338,(0),null);
var turn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11338,(1),null);
...
});})(i__11375,turn,c__5478__auto__,size__5479__auto__,b__11376,s__11374__$2,temp__5804__auto__,embeddings,selected_turn))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__11376),cogito$semantic_map_simple$simple_map_view_$_iter__11373(cljs.core.chunk_rest(s__11374__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__11376),null);
}
} else {
var turn = cljs.core.first(s__11374__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"circle","circle",1903212362),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"cx","cx",1272694324),new cljs.core.Keyword(null,"x","x",2099068185).cljs$core$IFn$_invoke$arity$1(turn),new cljs.core.Keyword(null,"cy","cy",755331060),(new cljs.core.Keyword(null,"y","y",-1757859776).cljs$core$IFn$_invoke$arity$1(turn) * 0.8),new cljs.core.Keyword(null,"r","r",-471384190),(5),new cljs.core.Keyword(null,"fill","fill",883462889),cogito.semantic_map_simple.get_participant_color(new cljs.core.Keyword(null,"participant_name","participant_name",1835821395).cljs$core$IFn$_invoke$arity$1(turn)),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (turn,s__11374__$2,temp__5804__auto__,embeddings,selected_turn){
return (function (){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("cogito.semantic-map-simple","set-selected-turn","cogito.semantic-map-simple/set-selected-turn",1855670088),turn], null));
});})(turn,s__11374__$2,temp__5804__auto__,embeddings,selected_turn))
], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"turn_id","turn_id",-911869226).cljs$core$IFn$_invoke$arity$1(turn)], null)),cogito$semantic_map_simple$simple_map_view_$_iter__11373(cljs.core.rest(s__11374__$2)));
}
} else {
return null;
}
