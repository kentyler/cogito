...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_11688 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_11688(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_11689 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_11689(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11690 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11690(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11691 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11691(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11692 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11692(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11696 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11696(reader);
}
});
...
var G__11708 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__11709 = s.append(c);
c = G__11708;
s = G__11709;
continue;
}
