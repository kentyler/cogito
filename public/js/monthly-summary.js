...
// Generates monthly summaries for each month of a selected year
...
window.MonthlySummary = {
    ...
    renderSummaryCard(month, summaryData) {
        // Month is in format "2024-01" for January 2024
    ...
    render() {
        console.log('MonthlySummary.render() called');
...
window.showMonthlySummary = function() {
    ...
    const container = document.getElementById('monthly-summary-content');
    if (container) {
        console.log('Monthly summary container found, rendering...');
