 ...
 * @param {string|Object} options.transcript - Transcript content (string or JSONB)
 * @param {string} options.meetingName - Name of the meeting
 * @param {string} options.meetingType - Type of meeting (e.g., 'workshop', 'standup')
 * @returns {Object|null} Generated summary object with topics and speakers
 */
